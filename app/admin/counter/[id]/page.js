        ...
        async function fetchCounters() {
            try {
                ...
                setFormData((prev) => ({
                    ...
                    od_servicetype: response.od_servicetype_id,
    ...
    return (
        <Paper sx={{ p: 3 }}>
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={3}>
                    <TextField fullWidth label="Job No" name="job_id" value={formData.job_id} onChange={handleChange} />
                </Grid>
                <Grid item xs={3}>
                    <TextField fullWidth label="WO Subject" name="subject" value={formData.subject} onChange={handleChange} />
                </Grid>
